...
const App: React.FC = () => {
  ...
  const handleSearch = useCallback(async (currentKeywords: string[]) => {
    ...
    setError(null);
    try {
      const fetchedPosts = await fetchSocialMediaPosts(currentKeywords);
  ...
  return (
    <div className="min-h-screen text-gray-800 font-sans">
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <Header />
        <main className="mt-6">
          <Filters keywords={keywords} onKeywordsChange={handleKeywordsChange} />
